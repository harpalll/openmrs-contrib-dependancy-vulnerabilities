...
import { severityScoreMap } from "./sorting";
...
export const transformReport = (
  ...
  raw.vulnerabilities.forEach((vuln) => {
    ...
    const alreadyExists = existing.cves.some((c) => c.id === vuln.id);

    if (!alreadyExists) {
      existing.cves.push(cve);
    }

    dependencyMap.get(key)!.cves.push(cve);
  });
...
export const tranformedReport = transformReport(
  {
    version: "15.0.6",
    schema:
      "https://gitlab.com/gitlab-org/security-products/security-report-schemas/-/raw/v15.0.6/dist/dependency-scanning-report-format.json?ref_type=tags",
    scan: {
      scanner: {
      ...
      end_time: "2026-02-18T20:21:47",
      start_time: "2026-02-18T20:21:47",
      status: "success",
    ...
    vulnerabilities: [
      {
        ...
        identifiers: [
          {
            type: "NVD",
            name: "CVE-2010-5312",
            value: "09c693bd3132031187b9c58a1d7b5bf2491361aa",

            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2010-5312",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
          dependency: {
            package: {
              name: "jquery-ui",
            },
        ...
        links: [
          {
            name: "BROKEN_LINK,THIRD_PARTY_ADVISORY,VDB_ENTRY",
          ...
          {
            name: "THIRD_PARTY_ADVISORY,VDB_ENTRY",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2010-5312",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            name: "CVE-2016-7103",
            value: "09c693bd3132031187b9c58a1d7b5bf2491361aa",
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2016-7103",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
        ...
        links: [
          ...
          {
            name: "EXPLOIT,ISSUE_TRACKING,PATCH,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "RELEASE_NOTES,VENDOR_ADVISORY",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2016-7103",
            url: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2016-7103",
          },
          {
            name: "https:\/\/snyk.io\/vuln\/npm:jquery-ui:20160721",
            url: "https:\/\/snyk.io\/vuln\/npm:jquery-ui:20160721",
          },
        ],
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2021-41182",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
        ...
        links: [
          ...
          {
            name: "EXPLOIT,MITIGATION,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2021-41182",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2021-41183",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
        ...
        links: [
          ...
          {
            name: "PATCH,RELEASE_NOTES,THIRD_PARTY_ADVISORY",
            url: "https:\/\/www.tenable.com\/security\/tns-2022-09",
          },
          {
            name: "PATCH,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2021-41183",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2021-41184",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
        ...
        links: [
          ...
          {
            name: "MITIGATION,PATCH,VENDOR_ADVISORY",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2021-41184",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2022-31160",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
        ...
        links: [
          ...
          {
            name: "EXPLOIT,MITIGATION,RELEASE_NOTES,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "https:\/\/github.com\/advisories\/GHSA-h6gj-6jjq-h8g9",
          ...
          {
            name: "https:\/\/github.com\/jquery\/jquery-ui\/issues\/2101",
            url: "https:\/\/github.com\/jquery\/jquery-ui\/issues\/2101",
          },
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2022-31160",
      ...
      },
      {
        ...
        identifiers: [
          {
            type: "NVD",
            name: "CVE-2012-6708",
            value: "9eb9ac595e9b5544e2dc79fff7cd2d0b4b5ef71f",

            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2012-6708",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
          dependency: {
            package: {
              name: "jquery",
            },
        ...
        links: [
          ...
          {
            name: "EXPLOIT,ISSUE_TRACKING,VENDOR_ADVISORY",
          ...
          {
            name: "http:\/\/bugs.jquery.com\/ticket\/11290",
            url: "http:\/\/bugs.jquery.com\/ticket\/11290",
          },
          {
            name: "http:\/\/research.insecurelabs.org\/jquery\/test\/",
            url: "http:\/\/research.insecurelabs.org\/jquery\/test\/",
          },
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2012-6708",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2015-9251",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
        ...
        links: [
          ...
          {
            name: "ISSUE_TRACKING,PATCH,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "THIRD_PARTY_ADVISORY,US_GOVERNMENT_RESOURCE",
          ...
          {
            name: "http:\/\/blog.jquery.com\/2016\/01\/08\/jquery-2-2-and-1-12-released\/",
          ...
          {
            name: "https:\/\/github.com\/advisories\/GHSA-rmxg-73gg-4p98",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2015-9251",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2019-11358",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
        ...
        links: [
          ...
          {
            name: "EXPLOIT,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "ISSUE_TRACKING,MAILING_LIST,THIRD_PARTY_ADVISORY",
            url: "https:\/\/seclists.org\/bugtraq\/2019\/Jun\/12",
          },
          {
            name: "MAILING_LIST,PATCH,THIRD_PARTY_ADVISORY",
            url: "http:\/\/seclists.org\/fulldisclosure\/2019\/May\/11",
          },
          {
            name: "MAILING_LIST,PATCH,THIRD_PARTY_ADVISORY",
          ...
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2019-11358",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2020-11022",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
        ...
        links: [
          ...
          {
            name: "EXPLOIT,THIRD_PARTY_ADVISORY,VDB_ENTRY",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2020-11023",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
        ...
        links: [
          ...
          {
            name: "BROKEN_LINK,MAILING_LIST,THIRD_PARTY_ADVISORY",
            url: "http:\/\/lists.opensuse.org\/opensuse-security-announce\/2020-11\/msg00039.html",
          },
          {
            name: "EXPLOIT,THIRD_PARTY_ADVISORY,VDB_ENTRY",
          ...
          {
            name: "ISSUE_TRACKING,MAILING_LIST",
            url: "https:\/\/lists.apache.org\/thread.html\/r0483ba0072783c2e1bfea613984bfb3c86e73ba8879d780dc1cc7d36%40%3Cissues.flink.apache.org%3E",
          },
          {
            name: "ISSUE_TRACKING,MAILING_LIST",
      ...
      },
      {
        ...
        identifiers: [
          {
            ...
            url: "https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2020-7656",
          },
        ],
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
        ...
        links: [
          ...
          {
            name: "https:\/\/github.com\/advisories\/GHSA-q4m3-2j7h-f7xw",
            url: "https:\/\/github.com\/advisories\/GHSA-q4m3-2j7h-f7xw",
          },
          {
            name: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2020-7656",
            url: "https:\/\/nvd.nist.gov\/vuln\/detail\/CVE-2020-7656",
          },
          {
            name: "https:\/\/research.insecurelabs.org\/jquery\/test\/",
      ...
      },
      {
        ...
        links: [
          {
            name: "https:\/\/github.com\/jquery\/jquery.com\/issues\/162",
            url: "https:\/\/github.com\/jquery\/jquery.com\/issues\/162",
          },
        ],
      },
      {
        ...
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs.war\/WEB-INF\/view\/scripts\/jquery-ui\/js\/jquery-ui.custom.min.js",
          dependency: {
            package: {
              name: "jquery-ui",
            },
      ...
      },
      {
        ...
        location: {
          file: "\/github\/workspace\/webapp\/target\/openmrs.war\/WEB-INF\/view\/scripts\/jquery\/jquery.min.js",
          dependency: {
            package: {
              name: "jquery",
            },
    ...
    dependency_files: [
      {
        ...
        dependencies: [
          ...
          {
            package: {
              name: "software.amazon.awssdk:annotations",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:arns",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:aws-core",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:checksums",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:crt-core",
            },
            version: "2.32.13",
          },
          {
            package: {
              name: "org.owasp:csrfguard",
            },
            version: "4.5.0-jakarta",
          },
          {
            package: {
          ...
          {
            package: {
              name: "software.amazon.awssdk:endpoints-spi",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "ca.uhn.hapi:hapi-base",
            },
            version: "2.1",
          },
          {
            package: {
              name: "ca.uhn.hapi:hapi-structures-v23",
            },
            version: "2.1",
          },
          {
            package: {
              name: "ca.uhn.hapi:hapi-structures-v24",
            },
            version: "2.1",
          },
          {
            package: {
              name: "ca.uhn.hapi:hapi-structures-v25",
            },
            version: "2.1",
          },
          {
            package: {
              name: "ca.uhn.hapi:hapi-structures-v26",
            },
            version: "2.1",
          },
          {
            package: {
              name: "org.hibernate.search:hibernate-search-backend-elasticsearch",
            },
            version: "8.2.1.Final",
          },
          {
            package: {
              name: "org.hibernate.search:hibernate-search-backend-lucene",
            },
            version: "8.2.1.Final",
          },
          {
            package: {
              name: "org.hibernate.search:hibernate-search-engine",
            },
            version: "8.2.1.Final",
          },
          {
          ...
          {
            package: {
              name: "org.hibernate.search:hibernate-search-mapper-pojo-base",
            },
            version: "8.2.1.Final",
          },
          {
            package: {
              name: "org.hibernate.search:hibernate-search-util-common",
            },
            version: "8.2.1.Final",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:http-auth",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:identity-spi",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "org.jboss.marshalling:jboss-marshalling",
            },
            version: "2.2.2.Final",
          },
          {
            package: {
              name: "org.jboss.marshalling:jboss-marshalling-river",
            },
            version: "2.2.2.Final",
          },
          {
          ...
          {
            package: {
              name: "com.github.cliftonlabs:json-simple",
            },
            version: "3.0.2",
          },
          {
            package: {
              name: "software.amazon.awssdk:json-utils",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "org.apache.lucene:lucene-analysis-phonetic",
            },
            version: "10.3.2",
          },
          {
          ...
          {
            package: {
              name: "org.apache.lucene:lucene-facet",
            },
            version: "9.12.3",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:metrics-spi",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "org.openmrs.liquibase:openmrs-liquibase",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.test:openmrs-test",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.test-suite:openmrs-test-suite",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.module:openmrs-test-suite-module-omod",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.module:openmrs-test-suite-module",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.module:openmrs-test-suite-module-api",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.test-suite:openmrs-test-suite-performance",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.web:openmrs-webapp",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
            package: {
              name: "org.openmrs.tools:openmrs-tools",
            },
            version: "3.0.0-SNAPSHOT",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:profiles",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:protocol-core",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:regions",
            },
            version: "2.32.13",
          },
          {
            package: {
              name: "software.amazon.awssdk:retries",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:sdk-core",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:third-party-jackson-core",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "software.amazon.awssdk:utils",
            },
            version: "2.32.13",
          },
          {
          ...
          {
            package: {
              name: "org.apache.velocity.tools:velocity-tools-generic",
            },
            version: "3.1",
          },
          {
